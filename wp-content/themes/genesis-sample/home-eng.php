...
function filter_expositions()
{
    ...
    echo do_shortcode('[searchandfilter id="503"]'); //home filter in FR

         if(pll_current_language() =='en'){

            echo do_shortcode('[searchandfilter id="646"]'); // home fiter in ENG in localhost
    //        echo do_shortcode('[searchandfilter id="995"]'); // home fiter in ENG in the online website
    }
